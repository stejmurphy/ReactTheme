...
function react_setup() {
	 ...
	 * If you're building a theme based on react, use a find and replace
	 * to change 'react' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'react', get_template_directory() . '/languages' );
...
function react_scripts() {
	...
	wp_enqueue_script( 'react-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'react-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
